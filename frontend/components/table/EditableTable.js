...
export default function TableSortAndSelection({fields = [], data = [], name = "", handleEditButtonClick, handleDeletePressed, handleRowSelected}) {
                  ...
                  >
                    ...
                    {handleDeletePressed && (
                      <Button 
                        ...
                        variant="plain" 
                        color="danger"
                        onClick={() => handleDeletePressed(row)}
                      >
                        Delete
                      </Button>
                    )}
